...
c_human.prototype.p_OnCreate=function(){
	...
	bb_audio_PlayMusic("bgm.mp3",1);
	this.m_HITSOUND=bb_audio_LoadSound("hit.mp3");
	...
	this.m_human.m_mainImage=bb_graphics_LoadImage("player.png",1,c_Image.m_DefaultFlags);
	this.m_human.m_mainImage.p_SetHandle(0.0,((this.m_human.m_mainImage.p_Height()/2)|0));
	this.m_human.m_x=10.0;
	this.m_human.m_y=430.0;
	this.m_bullet=c_myObject.m_new.call(new c_myObject);
	this.m_bullet.m_mainImage=bb_graphics_LoadImage("bullet.png",1,c_Image.m_DefaultFlags);
	this.m_bullet.m_mainImage.p_SetHandle(((this.m_bullet.m_mainImage.p_Width()/2)|0),((this.m_bullet.m_mainImage.p_Height()/2)|0));
	this.m_bullet.m_x=0.0;
	this.m_bullet.m_y=460.0;
	this.m_bullet.m_visible=false;
	var t_time=bb_app_Millisecs();
	var t_temp=((bb_random_Rnd3(t_time+200))|0);
	this.m_bird1=c_unit.m_new.call(new c_unit);
	this.m_bird1.m_mainImage=bb_graphics_LoadImage("bird.png",1,c_Image.m_DefaultFlags);
	this.m_bird1.m_mainImage.p_SetHandle(0.0,((this.m_bird1.m_mainImage.p_Height()/2)|0));
	this.m_bird1.m_x=600.0;
	this.m_bird1.m_y=200.0;
	this.m_bird1.m_visible=true;
	this.m_bird2=c_unit.m_new.call(new c_unit);
	this.m_bird2.m_mainImage=bb_graphics_LoadImage("bird2.png",1,c_Image.m_DefaultFlags);
	this.m_bird2.m_mainImage.p_SetHandle(0.0,((this.m_bird2.m_mainImage.p_Height()/2)|0));
	this.m_bird2.m_x=900.0;
	this.m_bird2.m_y=220.0;
	this.m_bird2.m_visible=true;
	this.m_bird3=c_unit.m_new.call(new c_unit);
	this.m_bird3.m_mainImage=bb_graphics_LoadImage("bird3.png",1,c_Image.m_DefaultFlags);
	this.m_bird3.m_mainImage.p_SetHandle(0.0,((this.m_bird3.m_mainImage.p_Height()/2)|0));
	this.m_bird3.m_x=800.0;
	this.m_bird3.m_y=234.0;
	this.m_bird3.m_visible=true;
	this.m_monster=c_unit.m_new.call(new c_unit);
	this.m_monster.m_mainImage=bb_graphics_LoadImage("gob1.png",1,c_Image.m_DefaultFlags);
	this.m_monster.m_mainImage.p_SetHandle(0.0,((this.m_monster.m_mainImage.p_Height()/2)|0));
	this.m_monster.m_x=700.0;
	this.m_monster.m_y=430.0;
	this.m_monster.m_visible=true;
	this.m_monster2=c_unit.m_new.call(new c_unit);
	this.m_monster2.m_mainImage=bb_graphics_LoadImage("gob2.png",1,c_Image.m_DefaultFlags);
	this.m_monster2.m_mainImage.p_SetHandle(0.0,((this.m_monster2.m_mainImage.p_Height()/2)|0));
	this.m_monster2.m_x=1000.0;
	this.m_monster2.m_y=425.0;
	this.m_monster2.m_visible=true;
	return 0;
}
c_human.prototype.p_OnUpdate=function(){
	var t_dx=bb_input_MouseX()-this.m_human.m_x;
	var t_dy=bb_input_MouseY()-this.m_human.m_y;
	var t_cursorAngle=(Math.atan2(t_dy,t_dx)*R2D);
	this.m_human.m_rotation=-t_cursorAngle;
	this.m_bird1.m_visible=true;
	this.m_bird2.m_visible=true;
	this.m_bird3.m_visible=true;
	this.m_monster.m_visible=true;
	this.m_monster2.m_visible=true;
	if(!this.m_bullet.m_visible){
		if((bb_input_MouseHit(0))!=0){
			this.m_HITSOUND=bb_audio_LoadSound("hit.mp3");
			bb_audio_PlaySound(this.m_HITSOUND,0,0);
			var t_cos=Math.cos((-this.m_human.m_rotation)*D2R);
			var t_sin=Math.sin((-this.m_human.m_rotation)*D2R);
			var t_speed=20.0;
			this.m_bullet.m_x=this.m_human.m_x+t_cos*100.0;
			this.m_bullet.m_y=this.m_human.m_y+t_sin*100.0;
			this.m_bullet.m_vx=t_cos*t_speed;
			this.m_bullet.m_vy=t_sin*t_speed;
			this.m_bullet.m_visible=true;
		}
	}else{
		this.m_bullet.m_vy+=0.7;
		var t_radians=(Math.atan2(this.m_bullet.m_vy,this.m_bullet.m_vx)*R2D);
		this.m_bullet.m_rotation=-t_radians;
		this.m_bullet.m_x+=this.m_bullet.m_vx;
		this.m_bullet.m_y+=this.m_bullet.m_vy;
		if(this.m_bullet.m_y>=(bb_app_DeviceHeight()) || this.m_bullet.m_x>=(bb_app_DeviceWidth())){
			this.m_bullet.m_visible=false;
		}
		if(this.m_bullet.m_x>this.m_bird1.m_x-15.0 && this.m_bullet.m_x<this.m_bird1.m_x+30.0){
			if(this.m_bullet.m_y>this.m_bird1.m_y-10.0 && this.m_bullet.m_y<this.m_bird1.m_y+15.0){
				this.m_bird1.m_visible=false;
				this.m_bird1.m_x=1000.0;
				bb_main_winPoint+=1;
			}
		}
		if(this.m_bullet.m_x>this.m_bird2.m_x-15.0 && this.m_bullet.m_x<this.m_bird2.m_x+15.0){
			if(this.m_bullet.m_y>this.m_bird2.m_y-15.0 && this.m_bullet.m_y<this.m_bird2.m_y+15.0){
				this.m_bird2.m_visible=false;
				this.m_bird2.m_x=1000.0;
				bb_main_winPoint+=1;
			}
		}
		if(this.m_bullet.m_x>this.m_bird3.m_x-15.0 && this.m_bullet.m_x<this.m_bird3.m_x+15.0){
			if(this.m_bullet.m_y>this.m_bird3.m_y-15.0 && this.m_bullet.m_y<this.m_bird3.m_y+15.0){
				this.m_bird3.m_visible=false;
				this.m_bird3.m_x=1000.0;
				bb_main_winPoint+=1;
			}
		}
		if(this.m_bullet.m_x>this.m_monster.m_x-15.0 && this.m_bullet.m_x<this.m_monster.m_x+15.0){
			if(this.m_bullet.m_y>this.m_monster.m_y-15.0 && this.m_bullet.m_y<this.m_monster.m_y+15.0){
				this.m_monster.m_visible=false;
				this.m_monster.m_x=1000.0;
				bb_main_winPoint+=1;
			}
		}
		if(this.m_bullet.m_x>this.m_monster2.m_x-15.0 && this.m_bullet.m_x<this.m_monster2.m_x+15.0){
			if(this.m_bullet.m_y>this.m_monster2.m_y-15.0 && this.m_bullet.m_y<this.m_monster2.m_y+15.0){
				this.m_monster2.m_visible=false;
				this.m_monster2.m_x=1000.0;
				bb_main_winPoint+=1;
			}
		}
	}
	this.m_bird1.m_x=this.m_bird1.m_x-2.0;
	this.m_bird2.m_x-=2.5;
	this.m_bird3.m_x=this.m_bird3.m_x-3.0;
	this.m_monster.m_x-=1.5;
	this.m_monster2.m_x-=1.7;
	if(this.m_bird1.m_x==10.0){
		bb_main_lifeCount-=1;
		this.m_bird1.m_x=600.0;
	}
	if(this.m_bird2.m_x==10.0){
		bb_main_lifeCount-=1;
		this.m_bird2.m_x=700.0;
	}
	if(this.m_bird3.m_x==10.0){
		bb_main_lifeCount-=1;
		this.m_bird3.m_x=630.0;
	}
	if(this.m_monster.m_x==10.0){
		bb_main_lifeCount-=1;
		this.m_monster.m_x=666.0;
	}
	if(this.m_monster2.m_x==10.0){
		bb_main_lifeCount-=1;
		this.m_monster2.m_x=720.0;
	}
	return 0;
}
c_human.prototype.p_OnRender=function(){
			...
			if(t_1==3){
				...
				if(t_1==2){
					...
					if(t_1==1){
						...
						if(t_1==0){
							this.m_bird1.m_visible=false;
							this.m_bird1.m_x=0.0;
							this.m_bird2.m_visible=false;
							this.m_bird3.m_visible=false;
							this.m_monster.m_visible=false;
							this.m_monster2.m_visible=false;
							this.m_bird2.m_x=0.0;
							this.m_bird3.m_x=0.0;
							this.m_monster.m_x=0.0;
							this.m_monster2.m_x=0.0;
	...
	bb_graphics_DrawText(String(bb_main_winPoint),100,100,201.0,201.0);
...
var bb_main_winPoint=0;
var bb_main_lifeCount=0;
